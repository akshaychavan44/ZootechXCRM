      ...
      {showAddLead && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className={`relative w-full max-w-[640px] rounded-2xl border shadow-2xl max-h-[90vh] overflow-auto ${bgCard}`}>
            <div className={`sticky top-0 p-5 border-b ${borderC} flex items-center justify-between backdrop-blur-xl ${isDark?"bg-[#14141f]/90":"bg-white/90"}`}><div><div className="font-bold text-[16px]">Add New Lead</div><div className={`text-[12px] ${textMuted}`}>Potential client details</div></div><button onClick={()=> setShowAddLead(false)} className={`h-8 w-8 rounded-xl border flex items-center justify-center hover:text-rose-500 hover:border-rose-300 dark:hover:border-rose-900/50 hover:bg-rose-50 dark:hover:bg-rose-950/30 transition-colors ${bgCard}`}><X size={16}/></button></div>
      ...
      {showFollowUpModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className={`relative w-full max-w-[520px] rounded-2xl border shadow-2xl ${bgCard}`}>
            <div className={`p-5 border-b ${borderC} flex items-center justify-between`}><div className="font-bold text-[16px]">Schedule Follow-up</div><button onClick={()=> setShowFollowUpModal(false)} className={`h-8 w-8 rounded-xl border flex items-center justify-center hover:text-rose-500 hover:border-rose-300 dark:hover:border-rose-900/50 hover:bg-rose-50 dark:hover:bg-rose-950/30 transition-colors ${bgCard}`}><X size={16}/></button></div>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className={`relative w-full max-w-[520px] rounded-2xl border shadow-2xl ${bgCard}`}>
            <div className={`p-5 border-b ${borderC} flex items-center justify-between`}>
              ...
              <button onClick={()=> { setShowCreateClient(false); setClientModalError(null); }} className={`h-8 w-8 rounded-xl border flex items-center justify-center hover:text-rose-500 hover:border-rose-300 dark:hover:border-rose-900/50 hover:bg-rose-50 dark:hover:bg-rose-950/30 transition-colors ${bgCard}`}><X size={16}/></button>
            </div>
            <div className="p-5 space-y-3">
              {clientModalError && (
      ...
      {showCreateQuote && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
          ...
          <div className={`relative w-full max-w-[480px] rounded-2xl border shadow-2xl ${bgCard}`}>
            <div className={`p-5 border-b ${borderC} flex items-center justify-between`}><div className="font-bold">Create Quotation</div><button onClick={()=> setShowCreateQuote(false)} className={`h-8 w-8 rounded-xl border flex items-center justify-center hover:text-rose-500 hover:border-rose-300 dark:hover:border-rose-900/50 hover:bg-rose-50 dark:hover:bg-rose-950/30 transition-colors ${bgCard}`}><X size={16}/></button></div>
            <div className="p-5 space-y-3">
      ...
      {selectedLead && (
        <div className="fixed inset-0 z-50 flex justify-end">
          ...
          <div className={`relative w-full max-w-[380px] h-full border-l shadow-2xl overflow-auto ${bgCard}`}>
            <div className={`p-5 border-b ${borderC} flex items-center justify-between sticky top-0 ${isDark?"bg-[#14141f]":"bg-white"}`}><div className="font-bold">Lead Details</div><button onClick={()=> setSelectedLead(null)} className={`h-8 w-8 rounded-xl border flex items-center justify-center hover:text-rose-500 hover:border-rose-300 dark:hover:border-rose-900/50 hover:bg-rose-50 dark:hover:bg-rose-950/30 transition-colors ${bgCard}`}><X size={16}/></button></div>
